 ...
 */
define("DOMPDF_INC_DIR", DOMPDF_DIR . "/dompdf_include");
...
function DOMPDF_autoload($class) {
  ...
  // i wish someone could explain to me why i need this smarty exception  ***arosenthal***
  if (strtolower($class) != 'smarty')
  		require_once(DOMPDF_INC_DIR . "/$filename");
  else
		;//error_log("doing the smarty sub in DOMPDF");
